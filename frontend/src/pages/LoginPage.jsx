    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="w-full max-w-md">
          ...
          {/* Welcome Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-semibold mb-2" style={{ color: '#1A1A1A' }}>Welcome Back</h1>
            <p style={{ color: '#6B7280' }}>Sign in to continue your college journey</p>
          </div>
        ...
        <div className="max-w-lg">
          ...
          >
            ...
            <p className="text-white/80 mb-6 leading-relaxed">
              Discover innovative programs, world-class faculty, and exceptional opportunities at one of America's most innovative universities.
            </p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-white/70">In Scholarships</div>
            </div>
            <div className="text-center">

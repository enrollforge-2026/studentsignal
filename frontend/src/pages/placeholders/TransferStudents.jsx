...
const TransferStudents = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await api.post('/api/leads', { email, first_name: '', last_name: '', college_id: 'transfer-students-interest' });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Transfer Students</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Make your transfer smooth and successful. Find transfer-friendly colleges, understand credit transfer policies, and get guidance on applications and deadlines.
          </p>
        </div>
        <div className="bg-white rounded-xl p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Coming Soon</h2>
          <p className="text-gray-600 mb-6">Be the first to know when we launch our transfer student guide. Enter your email below.</p>
